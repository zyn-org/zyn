...
mod tests {
  ...
  fn test_deserialize() {
    ...
    TestCase { name: "GET_CHAN_ACL", input: b"GET_CHAN_ACL id=1 channel=!1@localhost type=publish", expected: Ok(Message::GetChannelAcl(GetChannelAclParameters { id: 1, channel: StringAtom::from("!1@localhost"), r#type: StringAtom::from("publish"), page: None, page_size: None })) },
    TestCase { name: "GET_CHAN_ACL_PAGINATED", input: b"GET_CHAN_ACL id=1 channel=!1@localhost type=publish page=2 page_size=10", expected: Ok(Message::GetChannelAcl(GetChannelAclParameters { id: 1, channel: StringAtom::from("!1@localhost"), r#type: StringAtom::from("publish"), page: Some(2), page_size: Some(10) })) },
